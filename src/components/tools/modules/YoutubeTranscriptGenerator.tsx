...
export default function YoutubeTranscriptGenerator() {
  ...
  const handleDownload = () => {
    ...
    downloadOrShare(url, "youtube_analysis_" + new Date().toISOString().slice(0,10) + ".txt");
  };
        ...
        <div className="lg:col-span-5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 p-6 rounded-2xl shadow-xl flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white">YouTube Transcript Analyst</h3>
            </div>
            
            <p className="text-xs text-zinc-400 dark:text-zinc-500 mb-4">Structure and analyze transcripts from YouTube videos.</p>
            
<div className="space-y-2">
              <label className="block text-xs font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">YouTube Video URL</label>
              <input
                type="text"
                value={videoUrl}
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Actionable Takeaways / Summary">Actionable Takeaways / Summary</option>
              </select>
            </div>
          </div>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                <span>Analyze Video Transcript</span>
              </>
            )}
          </button>
        </div>
