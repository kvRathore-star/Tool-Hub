  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      ...
      <p className="text-zinc-400 max-w-md mx-auto mb-10 text-lg leading-relaxed">
        We are currently building the <span className="text-zinc-200 font-semibold">{toolName}</span> module. It will be powered entirely by your browser for maximum privacy.
      </p>
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full max-w-md mx-auto">
          <Input 
            ...
            required
            className="bg-zinc-900/50 border-white/10 text-white placeholder:text-zinc-600 flex-1 h-12 rounded-xl focus-visible:ring-blue-500"
          />
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left max-w-3xl mx-auto w-full border-t border-white/5 pt-12">
        <div>
