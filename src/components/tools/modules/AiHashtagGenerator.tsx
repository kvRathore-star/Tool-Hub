    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-zinc-900 border border-white/10 p-6 rounded-2xl shadow-xl space-y-4">
          <h4 className="text-white font-medium">Post Description</h4>
          <textarea 
            className="w-full bg-black border border-zinc-800 rounded-lg px-3 py-3 text-white h-32 outline-none focus:border-purple-500"
        ...
        <div className="bg-zinc-900 border border-white/10 p-6 rounded-2xl shadow-xl flex flex-col">
          <h4 className="text-white font-medium mb-4">Hashtags</h4>
          <textarea 
            className="flex-1 w-full bg-black border border-purple-500/30 rounded-lg px-4 py-3 text-purple-400 font-medium outline-none resize-none min-h-[200px]"
            readOnly
            value={output}
