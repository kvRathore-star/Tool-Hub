    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-zinc-900 border border-white/10 p-6 rounded-2xl shadow-xl space-y-6">
          <h4 className="text-white font-medium">Compression Settings</h4>
          
          <div>
            <label className="block text-sm text-zinc-400 mb-2">Target Bitrate</label>
            <select 
              value={bitrate}
              onChange={(e) => setBitrate(e.target.value)}
              className="w-full bg-black border border-zinc-800 rounded-lg px-3 py-3 text-white outline-none font-bold"
            >
        ...
        {outputUrl ? (
          ...
          <div className="bg-black border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
            ...
            <h4 className="text-white font-bold mb-2">Original Audio</h4>
